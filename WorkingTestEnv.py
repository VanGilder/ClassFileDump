...
target_phrases = ["email release", "release email", "proofpoint release", "release from proofpoint"]

# Set the autoclick coordinates for each detected phrase
autoclick_coordinates = {
    "email release": [(45, 309), (63, 257), (112, 293)],
    "release email": [(45, 309), (63, 257), (112, 293)],
    "proofpoint release": [(45, 309), (63, 257), (112, 293)],
    "release from proofpoint": [(45, 309), (63, 257), (112, 293)],
    "release an email": [(45, 309), (63, 257), (112, 293)],
    "proofpoint": [(45, 309), (63, 257), (112, 293)]
}
